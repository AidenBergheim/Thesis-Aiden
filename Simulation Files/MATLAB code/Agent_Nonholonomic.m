    ...
    methods
        ...
        function obj = getBearings(obj, cur_tStep, targets)
            ...
            if obj.localization_heading == zeros(2,1)
                ...
                % Convert this perpendicular angle into a 2x1 unit vector
                obj.localization_heading = [cos(perp_angle); sin(perp_angle)];
            end
        end


        % Individual target estimator
        ...
        % Achieves PDT heading convergence with smooth transitino
        ...
        % Proposed algorithm with saturation

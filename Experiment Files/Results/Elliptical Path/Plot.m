close all
clear all
T = readtable('Elliptical Data.csv');
end_index = 4100;
takeoff_index = 130;
...
x_zoom = [24, 38];      % x range to zoom into - adjust to your data
y_zoom = [-0.05, 0.05];  % y range to zoom into - adjust to your data

ax2_inset = axes('Position', [0.68, 0.72, 0.2, 0.08]); % [left bottom width height] in figure coords
box(ax2_inset, 'on');

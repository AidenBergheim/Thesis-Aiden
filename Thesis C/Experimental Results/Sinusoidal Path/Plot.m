...
ax2_inset = axes('Position', [0.68, 0.72, 0.16, 0.1]); % [left bottom width height] in figure coords
box(ax2_inset, 'on');
...
rectangle(ax2, 'Position', [x_zoom(1), y_zoom(1) - 0.1, diff(x_zoom), 3 * diff(y_zoom)], ...

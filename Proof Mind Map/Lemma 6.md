...
---
---
$P(t)$ is non-singular for all $t\leq T_{C,1}$
# Proof
---
...
$$0<C_1<\frac{d\gamma_{\nu_i}(t)}{dt}\leq C_2<\infty$$
It can also be seen that $t_{0,i}\geq 0$, $T_i>0$, $t_{0,i}+T_i<\mathcal{T_i}$, the angle $\gamma_{\nu_i}(t)$ is at least increased by a value of $C_1T_i$ over the interval $[t_{0,i}, t_{0,i}+T]$,

$$\gamma_{\nu_i}(t_{0,i} + T_i) \geq \gamma_{\nu_i}(t_{0,i}) +C_1T_{i}, \forall \boldsymbol{\nu_i} \in S^1.$$

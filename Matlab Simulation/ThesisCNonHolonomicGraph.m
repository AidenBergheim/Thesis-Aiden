...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    AgentPDT1 = Agent_Nonholonomic(p_0, x_hat_0, k_s, Tc0, Tc1, Tc2, ...
                        alpha_0, alpha_1, alpha_2, d_des_handle1, tSteps, qtyTargets, Targets, initial_heading);

    AgentPDT2 = Agent_Nonholonomic(p_0, x_hat_0, k_s, Tc0, Tc1, Tc2, ...
                        alpha_0, alpha_1, alpha_2, d_des_handle2, tSteps, qtyTargets, Targets, initial_heading);

    AgentPDT3 = Agent_Nonholonomic(p_0, x_hat_0, k_s, Tc0, Tc1, Tc2, ...
                        alpha_0, alpha_1, alpha_2, d_des_handle3, tSteps, qtyTargets, Targets, initial_heading);

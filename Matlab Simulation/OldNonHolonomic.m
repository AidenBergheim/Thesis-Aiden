...
% Plotting PDT Agent
    ...
    plot(AgentHolonomic.p_traj(1,1:mytStepFinal), AgentHolonomic.p_traj(2,1:mytStepFinal), ...
        'LineWidth', 2.5, ...
        'DisplayName', '$$\mbox{\boldmath$y$}(t)$$ [Holonomic Agent]',...
        'Color'      ,  'k');   
    hold on
...
% Plotting PDT Agent
    ...
    plot(real(AgentHolonomic.delta_traj),...
        'DisplayName', '$$\delta(t)$$ [Holonomic Agent]', ...
        'LineWidth', 2.5, ...
        'Color'      ,  'k');
    hold on
